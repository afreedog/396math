...
\begin{center}
	\begin{equation*}
	f_1(x)=\frac{\mathrm{e}^x+\mathrm{e}^{-x}}{2}
	\end{equation*}
	
	\ding{172}  \begin{equation*} f_1(x)=\frac{\mathrm{e}^x+\mathrm{e}^{-x}}{2} \begin{equation*} \qquad 
	\ding{173}  \begin{equation*}f_2(x)=\frac{\mathrm{e}^x-\mathrm{e}^{-x}}{2}\begin{equation*}  \qquad
	\ding{174}  \begin{equation*}f_3(x)=\ln \frac{1-x}{1+x}\begin{equation*}   \qquad 
	\ding{175}  \begin{equation*}f_4(x)=\ln \left(x+\sqrt{x^2+1}\right)\begin{equation*} 
\end{center}
