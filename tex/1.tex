...
\vspace{0.3cm}
\circledtext{1} \textbf{恒等式 }
$$ \sin ^2 \alpha+\cos ^2 \alpha=1;\quad 1+\tan ^2 \alpha=\sec ^2 \alpha ; \quad 1+\cot ^2 \alpha=\csc ^2 \alpha $$

\circledtext{2} \textbf{诱导公式 }
\begin{align*}
	& \sin \left(\frac{\pi}{2}+x\right)=\cos x; & & \sin \left(\frac{\pi}{2}-x\right)=\cos x; & & \cos \left(\frac{\pi}{2}+x\right)=-\sin x; & & \cos \left(\frac{\pi}{2}-x\right)=\sin x; \\
	& \sin (\pi+x)=-\sin x ;& & \sin (\pi-x)=\sin x ;& & \cos (\pi+x)=-\cos x; & & \cos (\pi-x)=-\cos x;
\end{align*}

\circledtext{3} \textbf{两角和公式、两角差公式}
\begin{align*}
...
\circledtext{4} \textbf{倍角公式、降幂公式}
\begin{align*}
	& \sin 2x = 2 \sin x \cos x; & &\cos 2x = \cos^2 x - \sin^2 x;  \\
	&  \sin^2 x = \frac{1-\cos 2x}{2} ; & & \cos^2 x = \frac{1+\cos 2x}{2};
\end{align*}

\circledtext{5} \textbf{积化和差公式、和差化积公式}
\begin{align*}
	& \sin x \cos y = \frac{1}{2}[\sin (x+y)+\sin (x-y)]; & 
	& \cos x \sin y = \frac{1}{2}[\sin (x+y)-\sin (x-y)]; \\
	& \cos x \cos y = \frac{1}{2}[\cos (x+y)+\cos (x-y)]; & 
	& \sin x \sin y = -\frac{1}{2}[\cos (x+y)-\cos (x-y)]; \\[1.5ex]
