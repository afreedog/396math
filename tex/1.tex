...
\begin{center}
	...
	\end{equation*}
	\ding{172}  $f_1(x)=\frac{\mathrm{e}^x+\mathrm{e}^{-x}}{2}$ \qquad \ding{173}  $f_2(x)=\frac{\mathrm{e}^x-\mathrm{e}^{-x}}{2}$ \qquad
	\ding{174} $f_3(x)=\ln \frac{1-x}{1+x}$  \qquad \ding{175} $f_4(x)=\ln \left(x+\sqrt{x^2+1}\right)$
\end{center}
